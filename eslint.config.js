...
module.exports = [
  ...
  prettierConfig,
  {
    ...
    // app/ holds standalone Fiori Elements UI5 projects (EPIC19) generated by
    // @sap-ux/fiori-elements-writer — browser/UI5 code (sap.ui.define AMD
    // modules using the global `sap`), each with its own tooling and lockfile,
    // not this backend's Node/Jest-focused rule set.
    ignores: ['node_modules/', 'gen/', 'coverage/', '.cds_gen/', 'app/'],
  },
];

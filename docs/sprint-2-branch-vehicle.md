...
| EPIC03-T8 | Cache-Bust Event Wiring — Wire `VehiclePublished`, `VehicleSold`, `VehicleReserved`, `VehicleReleased`, `VehicleCheckoutStarted` to catalog cache invalidation | In Progress |

...
| EPIC03-T3 | Vehicle Domain Model — `Vehicles` entity (all attributes), `VehicleStatus` enum (DRAFT→DELIVERED+ARCHIVED), `VehicleImages` entity, CDS schema + db file | In Progress |

...
| EPIC04-T3 | Offer Price Comparison — `compareToListPrice(vehicleId, offerAmount)` function in PricingService; returns diff vs. current list price and vs. lowest historical price | In Progress |
